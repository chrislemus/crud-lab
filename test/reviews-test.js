...
describe('Reviews Component', () => {
  ...
  it('displays a review for when it is associated with the restaurant', () => {
    ...
    store.dispatch({
      type: 'ADD_REVIEW',
      payload: { text: 'Was great', restaurantId },
    });
    store.dispatch({
      type: 'ADD_REVIEW',
      payload: { text: 'Was not great', restaurantId },
    });
    const wrapper = mount(
      <Provider store={store}>
        <App />
  ...
  it('does not display any review unassociated with the restaurant', () => {
    ...
    store.dispatch({
      type: 'ADD_REVIEW',
      payload: { text: 'it was good', restaurantId },
    });
    store.dispatch({
      type: 'ADD_REVIEW',
      payload: { text: 'it was great', restaurantId },
    });
    store.dispatch({
      type: 'ADD_REVIEW',
      payload: { text: 'it was bad', restaurantId: 'test' },
    });
    const wrapper = mount(
      <Provider store={store}>
        <App />
